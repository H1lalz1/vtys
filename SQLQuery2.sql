...
ALTER TABLE KITAP_YAZAR ADD CONSTRAINT "KITAP_YAZAR_KITAPLAR_FK" FOREIGN KEY ("ISBN") REFERENCES KITAPLAR(ISBN);
	...
	INSERT INTO UYELER VALUES('Ayþe','Kara','1','3561234556','aa@mail.com',NULL);
	INSERT INTO UYELER VALUES('Ali','Uçar','3','3562345667','au@abc.com',NULL);
	INSERT INTO UYELER VALUES('Ahmet','Davut','2','3563456778','ad@mail.com',NULL);
	INSERT INTO UYELER VALUES('Murat','Sönmez','1','35645646789','ms@krh.com',NULL);

	SELECT*FROM ADRESLER
	INSERT INTO ADRESLER VALUES('Orhangazi', 'Esentepe', 5, 'Tokat', '60100', 'Türkiye');
	INSERT INTO ADRESLER VALUES('Sivas','Kemer','34','Tokat','60100','Türkiye');
	INSERT INTO ADRESLER VALUES(NULL,'Evrenköy','21','Tokat','60400','Türkiye');
	INSERT INTO ADRESLER VALUES('Atatürk','Barbaros','142','Istanbul','34200','Türkiye');
	INSERT INTO ADRESLER VALUES('C.Gürsel','Tuna','65','Ýzmir','35600','Türkiye');
	INSERT INTO ADRESLER VALUES('Sipahi','Þamlar','85','Amasya','05200','Türkiye');
	DELETE FROM ADRESLER WHERE ADRES_NO=7

	UPDATE UYELER
	SET EPOSTA='ag@mail.com'
	WHERE UYE_NO=5 